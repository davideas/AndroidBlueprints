...
import eu.davidea.blueapp.ui.preferences.IPreference;
import eu.davidea.blueapp.utils.Utils;

/**
 * A {@link PreferenceActivity} that presents a set of application settings. On handset
 * devices, settings are presented as a single list. On tablets, settings are split by category,
 * with category headers shown to the left of the list of settings.
 * <p>
...
public class SettingsActivity extends AppCompatPreferenceActivity {
     ...
     */
    private static Preference.OnPreferenceChangeListener preferenceSummaryBinder = new PreferenceChangeListener();
